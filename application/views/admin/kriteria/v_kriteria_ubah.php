...
<?php
	...
	foreach ($tampil as $row) {
		...
		$id_tipe_preferensi=$row->id_tipe_preferensi;
		$min_max=$row->min_max;
		$q=$row->q;
		$p=$row->p;
		$s=$row->s;
...
<div class="row">
	<div class="col-lg-12">
		<div class="panel panel-default">
			<div class="panel-heading">Form Ubah Kriteria</div>
			<div class="panel-body">
				<div class="col-sm-12">
					<form class="form-horizontal"  method="POST" enctype="multipart/form-data" action="<?=base_url("admin/c_kriteria/ubah_proses");?>" >
					
						<div class="form-group">
							
							<div class="col-sm-10">
								<input type="hidden" style="width: 400px" class="form-control" name="id_kriteria" value="<?php echo $id_kriteria;?>" required>
							</div>							
						</div>
						<div class="form-group">
							<label class="col-sm-2 control-label">Nama Kriteria</label>
							<div class="col-sm-10">
								<input type="text" style="width: 400px" class="form-control" name="nama_kriteria" value="<?php echo $nama_kriteria;?>" placeholder="Nama Kriteria..." required>
							</div>							
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select class="form-control" id="kode" style="width: 100px" name="min_max" required="">
									<?php 
										foreach ($tampil as $row) {
											echo "<option ";
											if ( $id_kriteria == $row->id_kriteria) echo "selected";
											echo " value='$row->min_max'>".ucwords($row->min_max)."</option>";
										}
									?>						
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<select onchange="ubahtipe();" class="form-control" id="tipe" style="width: 150px" name="id_tipe_preferensi" required="">
									<?php 
										foreach ($rtipe as $row) {
											echo "<option ";
											if ( $id_tipe_preferensi == $row->id_tipe_preferensi) echo "selected";
											echo " value='$row->id_tipe_preferensi'>$row->nama_tipe_preferensi</option>";
										}
									?>
								</select>
							</div>							
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="number" style="width: 400px" class="form-control" min="0" max="2000" id="q" name="q" step='any' value="<?php echo $q;?>" disabled="">
							</div>							
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="number" style="width: 400px" class="form-control" min="0" max="2000" id="p" name="p" step='any' value="<?php echo $p;?>"  disabled="">
							</div>							
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="number" id="s" style="width: 400px" class="form-control" min="0" max="2000" name="s" step='any' value="<?php echo $s;?>" disabled="">
							</div>							
						</div>
